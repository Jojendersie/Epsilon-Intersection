...
bool test_quaternion()
{
    ...
    TEST( approx(xaxis(q1), Vec3(m1(0,0), m1(1,0), m1(2,0))), "X-axis of quaternion q1 wrong!" );
    TEST( approx(yaxis(q1), Vec3(m1(0,1), m1(1,1), m1(2,1))), "Y-axis of quaternion q1 wrong!" );
    TEST( approx(zaxis(q1), Vec3(m1(0,2), m1(1,2), m1(2,2))), "Z-axis of quaternion q1 wrong!" );
