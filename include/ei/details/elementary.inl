...
// ************************************************************************* //
template<typename T>
inline T max(T _x, T _y) noexcept
{
    return _x < _y ? _y : _x;
}

template<typename T, typename... Ttail>
inline T max(T _first, Ttail... _tail) noexcept
{
...
// ************************************************************************* //
template<typename T>
inline T min(T _x, T _y) noexcept
{
    return _x > _y ? _y : _x;
}

template<typename T, typename... Ttail>
inline T min(T _first, Ttail... _tail) noexcept
{
...
// ************************************************************************* //
template<typename T>
inline T clamp(T _x, T _min, T _max) noexcept
{
...
inline bool approx(T _x0, T _x1, T _epsilon) noexcept
{
...
// ********************************************************************* //
template<typename T>
T intfrac(T _x, typename details::Int<sizeof(T)>::stype& _int) noexcept
{
...
// ********************************************************************* //
template<typename T>
T floorfrac(T _x, typename details::Int<sizeof(T)>::stype& _int) noexcept
{
    _int = floor(_x);
    return _x - _int;
}
...
auto lerp(T0 _x0, T0 _x1, T1 _t) noexcept -> decltype(_x0*_t)
{
...
auto bilerp(T0 _x00, T0 _x01,
            T0 _x10, T0 _x11,
            T1 _t0, T1 _t1) noexcept -> decltype(_x00*_t0)
{
