...
namespace ei {
    ...
    EIAPI inline float sRgbToRgb(float _c)  // TESTED
    {
        if(_c <= 0.0031308f)
            return _c * 12.92f;
    ...
    EIAPI inline Vec3 rgbToSRgb(const Vec3 & _rgb)  // TESTED
    {
    ...
    EIAPI inline Vec3 xyzToRgb(const Vec3 & _xyz)  // TESTED
    {
    ...
    EIAPI inline Vec3 rgbToXyz(const Vec3 & _rgb)  // TESTED
    {
    ...
    EIAPI inline uint32 packR11G11B10(Vec3 _v)  // TESTED
    {
    ...
    // Note: This is not the R11G11B10F (float) format from textures!
    EIAPI inline Vec3 unpackR11G11B10(uint32 _code)  // TESTED
    {
        return Vec3 {
    ...
    EIAPI inline uint32 packOctahedral32(const Vec3 & _d)  // TESTED
    {
    ...
    EIAPI inline Vec3 unpackOctahedral32(uint32 _code)  // TESTED
    {
