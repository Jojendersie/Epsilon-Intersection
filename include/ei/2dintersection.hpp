...
namespace ei {
    ...
    EIAPI inline float distanceSq(const Vec2& _point, const Segment2D& _line)         // TESTED
    {
    ...
    EIAPI inline float distance(const Vec2& _point, const Rect2D& _rect)
    {
    ...
    EIAPI inline float distance(const Vec2& _point, const Segment2D& _line)           { return sqrt(distanceSq(_point, _line)); }
    EIAPI inline float distanceSq(const Segment2D& _line, const Vec2& _point)         { return distanceSq(_point, _line); }
    EIAPI inline float distance(const Segment2D& _line, const Vec2& _point)           { return sqrt(distanceSq(_point, _line)); }
    EIAPI inline float distance(const Rect2D& _rect, const Vec2& _point)              { return distance(_point, _rect); }

    EIAPI inline bool intersects( const Vec2& _point, const Capsule2D& _capsule )     // TESTED
    {
        return distanceSq(_point, _capsule.seg) <= _capsule.radius * _capsule.radius;
    }
    EIAPI inline bool intersects( const Capsule2D& _capsule, const Vec2& _point )     { return intersects(_point, _capsule); }

    /// \brief Does a point lie inside a circle/on the boundary?
    /// \details Performance index: TODO
    /// \return true if the point is inside or on the boundary.
    EIAPI inline bool intersects( const Vec2& _point, const Disc2D& _disc )           // TESTED
    {
        return lensq(_point - _disc.center) <= sq(_disc.radius);
    }
    EIAPI inline bool intersects( const Disc2D& _disc, const Vec2& _point )  { return intersects( _point, _disc ); }
    ...
    EIAPI inline bool intersects( const Disc2D& _disc0, const Disc2D& _disc1 )        // TESTED
    {
    ...
    /// \return true if the discs intersect in two or one point or one lies
    ///    fully inside the other one.
    EIAPI inline bool intersects( const Disc2D& _disc0, const Disc2D& _disc1, Vec2& _outInfo ) // TESTED
    {
    ...
    ///    fully inside the other one.
    EIAPI inline bool intersects( const Rect2D& _rect0, const Rect2D& _rect1 )        // TESTED
    {
    ...
    /// \details Performance index: TODO
    /// \return true if the point is inside or on the boundary.
    EIAPI inline bool intersects( const Vec2& _point, const Rect2D& _rect )           // TESTED
    {
        return (_point >= _rect.min) && (_point <= _rect.max);
    }
    EIAPI inline bool intersects( const Rect2D& _rect, const Vec2& _point )  { return intersects( _point, _rect ); }

    /// \brief Do a rectangle and disc intersect/touch?
    /// \details Performance index: TODO
    /// \return true if the rectangle and disc intersect or one lies
    ///    fully inside the other one.
    EIAPI inline bool intersects( const Disc2D& _disc, const Rect2D& _rect )          // TESTED
    {
        return ( _disc.center + _disc.radius >= _rect.min )
            && ( _disc.center - _disc.radius <= _rect.max );
    }
    EIAPI inline bool intersects( const Rect2D& _rect, const Disc2D& _disc )  { return intersects(_disc, _rect); }

    /// \brief Do two lines intersect/touch?
    /// \details Performance index: TODO
    /// \return true if the lines intersect.
    EIAPI inline bool intersects( const Segment2D& _line0, const Segment2D& _line1 )  // TESTED
    {
    ...
    /// \return true if the lines intersect.
    EIAPI inline bool intersects( const Segment2D& _line0, const Segment2D& _line1, Vec2& _outInfo )  // TESTED
    {
        Vec2 dir0 = _line0.b - _line0.a;
        Vec2 dir1 = _line1.b - _line1.a;
        // Solve _line0.p0 + s * dir0 == _line1.p0 + t * dir1
