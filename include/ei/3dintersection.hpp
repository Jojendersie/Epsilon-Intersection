...
namespace ei {
    ...
    EIAPI inline float distance(const Vec3& _point0, const Vec3& _point1)            // TESTED
    {
        return len(_point1 - _point0);
    }

    EIAPI inline float distance(const Vec3& _point, const Segment& _line)            // TESTED
    {
    ...
    EIAPI inline float distance(const Vec3& _point, const Triangle& _triangle)       // TESTED
    {
    ...
    EIAPI inline float distance(const Vec3& _point, const Sphere& _sphere)           // TESTED
    {
        return distance(_sphere.center, _point) - _sphere.radius;
    }

    EIAPI inline float distance(const Vec3& _point, const Capsule& _capsule)         // TESTED
    {
        return distance(_point, _capsule.seg) - _capsule.radius;
    }

    EIAPI inline float distance(const Vec3& _point, const Ray& _ray)
    {
    ...
    EIAPI inline float distance(const Vec3& _point, const Box& _box)                 // TESTED
    {
    ...
    EIAPI inline float distance(const Vec3& _point, const Plane& _plane)             // TESTED
    {
    ...
    EIAPI inline float distance(const Vec3& _point, const DOP& _dop)
    {
    ...
    EIAPI inline float distance(const Sphere& _sphere, const Segment& _segment)      // TESTED
    {
        return max(0.0f, distance(_sphere.center, _segment) - _sphere.radius);
    }

    EIAPI inline float distance(const Sphere& _sphere, const Capsule& _capsule)      // TESTED
    {
        return max(0.0f, distance(_sphere.center, _capsule.seg) - _capsule.radius - _sphere.radius);
    }

    EIAPI inline float distance(const Sphere& _sphere, const Box& _box)              // TESTED
    {
        eiAssert(_box.min <= _box.max, "Invalid box!");
    ...
    EIAPI inline float distance(const Sphere& _sphere, const Plane& _plane)          // TESTED
    {
        eiAssert(approx(1.0f, len(_plane.n)), "The plane is not normalized!");
        eiAssert(_sphere.radius >= 0.0f, "Invalid sphere!");
    ...
    EIAPI inline float distance(const Segment& _line0, const Segment& _line1)        // TESTED
    {
    ...
    EIAPI inline float distance(const Capsule& _capsule0, const Capsule& _capsule1)  // TESTED
    {
        return max(0.0f, distance(_capsule0.seg, _capsule1.seg) - _capsule0.radius - _capsule1.radius);
    }

    EIAPI inline float distance(const Segment& _line, const Vec3& _point)            { return distance(_point, _line); }
    EIAPI inline float distance(const Triangle& _triangle, const Vec3& _point)       { return distance(_point, _triangle); }
    EIAPI inline float distance(const Sphere& _sphere, const Vec3& _point)           { return distance(_point, _sphere); }
    EIAPI inline float distance(const Capsule& _capsule, const Vec3& _point)         { return distance(_point, _capsule); }
    EIAPI inline float distance(const Capsule& _capsule, const Sphere& _sphere)      { return distance(_sphere, _capsule); }
    EIAPI inline float distance(const Box& _box, const Vec3& _point)                 { return distance(_point, _box); }
    EIAPI inline float distance(const Box& _box, const Sphere& _sphere)              { return distance(_sphere, _box); }
    EIAPI inline float distance(const Plane& _plane, const Vec3& _point)             { return distance(_point, _plane); }
    EIAPI inline float distance(const Plane& _plane, const Sphere& _sphere)          { return distance(_sphere, _plane); }
    EIAPI inline float distance(const DOP& _dop, const Vec3& _point)                 { return distance(_point, _dop); }
    EIAPI inline float distance(const Ray& _ray, const Vec3& _point)                 { return distance(_point, _ray); }
    ...
    EIAPI inline bool intersects( const Sphere& _sphere0, const Sphere& _sphere1 )   // TESTED
    {
    ...
    EIAPI inline bool intersects( const Vec3& _point, const Sphere& _sphere )        // TESTED
    {
        return lensq(_point-_sphere.center) <= sq(_sphere.radius);
    }

    EIAPI inline bool intersects( const Sphere& _sphere, const Vec3& _point )  { return intersects( _point, _sphere ); }

    /// \brief Do a sphere and a box intersect?
    /// \return true if the sphere and the box have at least one point in common.
    EIAPI inline bool intersects( const Sphere& _sphere, const Box& _box )               // TESTED
    {
    ...
    EIAPI inline bool intersects( const Box& _box, const Sphere& _sphere )  { return intersects( _sphere, _box ); }

    /// \brief Does a point lie inside a box/on the boundary?
    /// \return true if the point is inside or on the boundary.
    EIAPI inline bool intersects( const Vec3& _point, const Box& _box )              // TESTED
    {
    ...
    EIAPI inline bool intersects( const Box& _box, const Vec3& _point )  { return intersects( _point, _box ); }

    /// \brief Does a point lie inside a box/on the boundary?
    /// \return true if both boxes have at least one point in common.
    EIAPI inline bool intersects( const Box& _box0, const Box& _box1 )               // TESTED
    {
...
//            <= ((_box0.max - _box0.min) + (_box1.max - _box1.min)));
    ...
    /// \return true if both spheres have at least one point in common.
    EIAPI inline bool intersects( const Capsule& _capsule0, const Capsule& _capsule1 ) // TESTED
    {
    ...
    /// \return true if the point is inside or on the boundary.
    EIAPI inline bool intersects( const Vec3& _point, const Ellipsoid& _ellipsoid )  // TESTED
    {
    ...
    EIAPI inline bool intersects( const Ellipsoid& _ellipsoid, const Vec3& _point )  { return intersects( _point, _ellipsoid ); }

    /// \brief Does a point lie inside an oriented ellipsoid/on the boundary?
    /// \return true if the point is inside or on the boundary.
    EIAPI inline bool intersects( const Vec3& _point, const OEllipsoid& _oellipsoid ) // TESTED
    {
    ...
    EIAPI inline bool intersects( const OEllipsoid& _oellipsoid, const Vec3& _point )  { return intersects( _point, _oellipsoid ); }

    /// \brief Does a point lie inside a DOP or on the boundary?
    /// \return true if the point is inside or on the boundary.
    EIAPI inline bool intersects( const Vec3& _point, const DOP& _dop )              // TESTED
    {
    ...
    EIAPI inline bool intersects( const DOP& _dop, const Vec3& _point )  { return intersects( _point, _dop ); }
    ...
    EIAPI inline bool intersects( const Vec3& _point, const OBox& _obox )            // TESTED
    {
    ...
    EIAPI inline bool intersects( const OBox& _obox, const Vec3& _point )          { return intersects(_point, _obox); }
    ...
    ///     ellipsoid.
    EIAPI inline bool intersects( const Ray& _ray, const Ellipsoid& _ellipsoid )     // TESTED
    {
        // Translate to origin
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Ellipsoid& _ellipsoid, float& _distance )
    {
        // Translate to origin
        Vec3 o = _ray.origin - _ellipsoid.center;
    ...
    EIAPI inline bool intersects( const Ellipsoid& _ellipsoid, const Ray& _ray )  { return intersects( _ray, _ellipsoid ); }
    EIAPI inline bool intersects( const Ellipsoid& _ellipsoid, const Ray& _ray, float& _distance )  { return intersects( _ray, _ellipsoid, _distance ); }
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Box& _box )                 // TESTED
    {
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Box& _box, float& _distance )
    {
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Box& _box, float& _distance, HitSide& _side )
    {
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Box& _box, float& _distance, float& _distanceExit )
    {
        float tmin, tmax, tymin, tymax, tzmin, tzmax;
        const Vec3 * bbounds = (const Vec3 *)&_box;
    ...
    EIAPI inline bool intersects( const FastRay& _ray, const Box& _box, float& _distance )
    {
        float tmin, tmax, tymin, tymax, tzmin, tzmax;
        const Vec3 * bbounds = (const Vec3 *)&_box;
    ...
    EIAPI inline bool intersects( const Box& _box, const Ray& _ray )  { return intersects( _ray, _box ); }
    EIAPI inline bool intersects( const Box& _box, const Ray& _ray, float& _distance )  { return intersects( _ray, _box, _distance ); }
    EIAPI inline bool intersects( const Box& _box, const Ray& _ray, float& _distance, HitSide& _side )  { return intersects( _ray, _box, _distance, _side ); }
    EIAPI inline bool intersects( const Box& _box, const Ray& _ray, float& _distance, float& _distanceExit )  { return intersects( _ray, _box, _distance, _distanceExit ); }
    EIAPI inline bool intersects( const Box& _box, const FastRay& _ray, float& _distance )  { return intersects( _ray, _box, _distance ); }

    /// \brief Do an oriented box and a ray intersect or touch?
    EIAPI inline bool intersects( const Ray& _ray, const OBox& _obox )               // TESTED
    {
    ...
    EIAPI inline bool intersects( const Ray& _ray, const OBox& _obox, float& _distance )
    {
        // Transform the ray such that the box is centered at the origin
        Ray ray;
        ray.origin = transform( _ray.origin - _obox.center, conjugate(_obox.orientation) );
    ...
    EIAPI inline bool intersects( const OBox& _obox, const Ray& _ray ) { return intersects( _ray, _obox ); }
    EIAPI inline bool intersects( const OBox& _obox, const Ray& _ray, float& _distance ) { return intersects( _ray, _obox, _distance ); }
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Triangle& _triangle )       // TESTED
    {
        // Möller and Trumbore
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Triangle& _triangle, float& _distance )   // TESTED
    {
        // Möller and Trumbore
        Vec3 e0 = _triangle.v1 - _triangle.v0;
        Vec3 e1 = _triangle.v0 - _triangle.v2;
    ...
    EIAPI inline bool intersects( const Ray& _ray, const FastTriangle& _triangle, float& _distance )   // TESTED
    {
    ...
    EIAPI inline bool intersects( const Ray& _ray, const Triangle& _triangle, float& _distance, Vec3& _barycentric )    // TESTED
    {
        // Möller and Trumbore
        Vec3 e0 = _triangle.v1 - _triangle.v0;
        Vec3 e1 = _triangle.v0 - _triangle.v2;
    ...
    EIAPI inline bool intersects( const Ray& _ray, const FastTriangle& _triangle, float& _distance, Vec3& _barycentric )  // TESTED
    {
        float cosT = dot( _triangle.normal, _ray.direction );
        float cosT2AInv = 0.5f / (cosT * _triangle.area);
        Vec3 o = (_triangle.v0 - _ray.origin);
    ...
    EIAPI inline bool intersects( const Triangle& _triangle, const Ray& _ray )  { return intersects( _ray, _triangle ); }
    EIAPI inline bool intersects( const Triangle& _triangle, const Ray& _ray, float& _distance )  { return intersects( _ray, _triangle, _distance ); }
    EIAPI inline bool intersects( const FastTriangle& _triangle, const Ray& _ray, float& _distance )  { return intersects( _ray, _triangle, _distance ); }
    EIAPI inline bool intersects( const Triangle& _triangle, const Ray& _ray, float& _distance, Vec3& _barycentric )  { return intersects( _ray, _triangle, _distance, _barycentric ); }
    EIAPI inline bool intersects( const FastTriangle& _triangle, const Ray& _ray, float& _distance, Vec3& _barycentric )  { return intersects( _ray, _triangle, _distance, _barycentric ); }

    /// \brief Do a sphere and a plane intersect or touch?
    /// \return true if there is at least one point in common.
    EIAPI inline bool intersects( const Sphere& _sphere, const Plane& _plane )       // TESTED
    {
        return abs(dot(_plane.n, _sphere.center) + _plane.d) <= _sphere.radius;
    }

    EIAPI inline bool intersects( const Plane& _plane, const Sphere& _sphere )       { return intersects(_sphere, _plane); }

    /// \brief Does the sphere touches the triangle?
    /// \return true if the sphere and the triangle have at least one point in common.
    EIAPI inline bool intersects( const Sphere& _sphere, const Triangle& _triangle ) // TESTED
    {
        Vec3 a = _triangle.v1-_triangle.v0;
        Vec3 b = _triangle.v2-_triangle.v1;
        Vec3 c = _triangle.v2-_triangle.v0;
    ...
    EIAPI inline bool intersects( const Triangle& _triangle, const Sphere& _sphere ) { return intersects(_sphere, _triangle); }
    ...
    EIAPI inline bool intersects( const Sphere& _sphere, const Capsule& _capsule )   // TESTED
    {
        return distance(_sphere.center, _capsule.seg) <= _capsule.radius + _sphere.radius;
    }

    EIAPI inline bool intersects( const Capsule& _capsule, const Sphere& _sphere )   { return intersects(_sphere, _capsule); }
    ...
    EIAPI inline bool intersects( const Vec3& _point, const Capsule& _capsule )      // TESTED
    {
        return distance(_point, _capsule.seg) <= _capsule.radius;
    }

    EIAPI inline bool intersects( const Capsule& _capsule, const Vec3& _point )      { return intersects(_point, _capsule); }
    ...
    EIAPI inline bool intersects( const Vec3& _point, const FastFrustum& _frustum )  // TESTED
    {
    ...
    EIAPI inline bool intersects( const FastFrustum& _frustum, const Vec3& _point )  { return intersects(_point, _frustum); }
    ...
    EIAPI inline bool intersects( const Sphere& _sphere, const FastFrustum& _frustum )    // TESTED
    {
    ...
    EIAPI inline bool intersects( const Box& _box, const FastFrustum& _frustum )       // TESTED
    {
    ...
    EIAPI inline bool intersects( const FastFrustum& _frustum, const Box& _box )     { return intersects(_box, _frustum); }
    ...
    EIAPI inline bool intersects( const Vec3& _point, const Tetrahedron& _tetrahedron )    // TESTED
    {
    ...
    EIAPI inline bool intersects( const Tetrahedron& _tetrahedron, const Vec3& _point ) { return intersects(_point, _tetrahedron); }
    ...
    EIAPI inline bool intersects( const Triangle& _triangle, const Box& _box )          // TESTED
    {
    ...
    EIAPI inline bool intersects( const Box& _box, const Triangle& _triangle ) { return intersects(_triangle, _box); }

    /// \brief Intersection test between triangle and oriented box (based on SAT).
    /// \return true if the triangle and the box have at least one point in common.
    EIAPI inline bool intersects( const Triangle& _triangle, const OBox& _obox )     // TESTED
    {
    ...
    EIAPI inline bool intersects( const OBox& _obox, const Triangle& _triangle ) { return intersects(_triangle, _obox); }

    /// \brief Intersection test between plane and box.
    /// \return true if the plane and the box have at least one point in common.
    EIAPI inline bool intersects( const Plane& _plane, const Box& _box )
    {
        // Instead looping over all eight corners we only compute the minimum and
    ...
    EIAPI inline bool intersects( const Box& _box, const Plane& _plane ) { return intersects(_plane, _box); }
    ...
    EIAPI inline bool intersects( const Plane& _plane, const OBox& _obox )
    {
    ...
    EIAPI inline bool intersects( const OBox& _obox, const Plane& _plane ) { return intersects(_plane, _obox); }

    /// \brief Intersection test between cone and point.
    EIAPI inline bool intersects( const Vec3& _point, const Cone& _cone )
    {
    ...
    EIAPI inline bool intersects( const Cone& _cone, const Vec3& _point ) { return intersects(_point, _cone); }
    
    EIAPI inline bool intersects( const Vec3& _point, const FastCone& _cone )
    {
    ...
    EIAPI inline bool intersects( const FastCone& _cone, const Vec3& _point ) { return intersects(_point, _cone); }

    /// \brief Intersection test between cone and triangle.
    EIAPI inline bool intersects( const Triangle& _triangle, const Cone& _cone )
    {
    ...
    EIAPI inline bool intersects( const Cone& _cone, const Triangle& _triangle ) { return intersects(_triangle, _cone); }
}
